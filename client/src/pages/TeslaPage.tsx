  ...
  useEffect(() => {
    const fetchVehicles = async () => {
      try {
        ...
        setVehicles(res.data.filter((v: Vehicle) => v.brand === 'Tesla'));
      } catch (err) {
    ...
    <div className="min-h-screen bg-ink-950 pt-24 pb-20">
      <div className="section-padding">
        <div className="text-center mb-12">
          <h1 className="font-display text-4xl font-bold text-white mb-3">All Tesla Electric Models</h1>
          <p className="text-gray-400 max-w-2xl mx-auto">
            Choose your preferred Tesla electric car. All models are brand new editions delivered straight to your door.
          </p>
        </div>
